...
# 2022-04-12 - v1.3 - glorang - Make sure to expand user in keytab path
# 2022-04-13 - v1.4 - glorang - Always use a fixed Kerberos cache
# 2022-06-24 - v1.5 - glorang - Only try keytab method if specified in .hgrc
# 2022-10-11 - v1.6 - glorang - Add support for ToroiseHG >= 6.2 (Windows, Python 3)
# 2022-11-09 - v1.7 - glorang - Replace subprocess.Popen() with subprocess.run()
#
...
class KerberosAuthHandler(urllib.BaseHandler):
	...
	def __init__(self, ui, passmgr):
		...
		# See Intranet Mercurial page for instructions on how to generate the keytab
